 ...
 *
 * The three boxes are `size-10` to match the header's icon buttons, which
 * override `Button size="icon"` (32px) up to 40px via className — the shared
  ...
  return (
    <>
      {Array.from({ length: 3 }, (_, i) => (
        <div key={i} className="size-10 rounded-lg" aria-hidden />
      ))}
